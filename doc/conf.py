...
latex_documents = [
    ("index", "Fail2Ban.tex", u"Fail2Ban Developers' Documentation", u"", "manual"),
]
...
man_pages = [("index", "fail2ban", u"Fail2Ban Developers' Documentation", [u""], 1)]
...
texinfo_documents = [
    (
        "index",
        "Fail2Ban",
        u"Fail2Ban Developers' Documentation",
        u"",
        "Fail2Ban",
