...
class TicketTests(unittest.TestCase):
    def testTicket(self):
        ...
        # estimated attempts count
        self.assertEqual(ft.getAttempt(), 4)
        # real known failure count
    ...
    def testTicketData(self):
        ...
        t.setData(
            {"region": None, "country": "FR", "city": "Paris"},
        )
        ...
        self.assertEqual(
            t.getData(), {"region": "Bremen", "country": "DE", "city": "Bremen"}
        )
        ...
        self.assertEqual(
            t.getData(), {"city": "Berlin", "region": "Brandenburg", "country": "DE"}
        )
        # interator filter :
        self.assertEqual(
            t.getData(("city", "country")), {"city": "Berlin", "country": "DE"}
        )
        # callable filter :
        ...
        self.assertEqual(
            t.getData(), {"continent": "Europe", "country": "RU", "region": "Moscow"}
        )
        # clear:
        t.setData({})
